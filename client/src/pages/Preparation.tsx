    ...
    <Layout overlayHeader>
      <SignalPageShell>
        ...
        <section
          ref={heroRef}
          className="fi-hero"
          aria-labelledby="prep-hero-title"
        >
            ...
            <div className="fi-hero__text">
              ...
              >
                <span className="fi-enter fi-enter--wordmark">
                  <DecodedTitle text="PREPARATION" as="span" interval={74} />
                </span>
              ...
              <p className="fi-hero__voice fi-enter fi-enter--voice">
                The archive stands ready. From this moment, in another, the next 
                phase begins. Prepare your resonance.
              </p>
