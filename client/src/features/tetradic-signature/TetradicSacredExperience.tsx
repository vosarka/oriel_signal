...
export type TetradicSacredExperienceProps = Readonly<{
  reducedMotion?: boolean;
  compact?: boolean;
  lenis?: Lenis;
  founderEdition?: Omit<TetradicFounderEditionProps, "reducedMotion">;
}>;
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="tetradic-sacred__page-reveal-inner"
      ...
      <TetradicFounderEdition
        isAuthenticated={founderEdition?.isAuthenticated ?? false}
        user={founderEdition?.user ?? null}
        reducedMotion={reducedMotion}
        onRequireLogin={founderEdition?.onRequireLogin ?? (() => undefined)}
        onCreateCheckpoint={
          founderEdition?.onCreateCheckpoint ?? (async () => ({ orderId: 0 }))
        }
        onContinueToPayPal={
          founderEdition?.onContinueToPayPal ?? (() => undefined)
        }
      />
    </>
  );
